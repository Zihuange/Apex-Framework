...
_teamspeak_server = 'Teamspeak:150.138.77.205 QQ群:813940305';					// Teamspeak server address, for use with map marker, map tabs, ec. Customize this accordingly.		Example:	_teamspeak_server = 'ts3.address.com : 1234     - Password: N/A';
...
_discord_server = 
[
	"'https://github.com/Zihuange/Apex-Framework'",														// Discord server (change this to yours).	Example:	"'https://goo.gl/7Xajd9'"
...
_community_logo = '';
_community_flag_texture = 'a3\data_f\flags\flag_csat_co.paa';						// Community texture applied to some flags.		Default: 'a3\data_f\flags\flag_nato_co.paa'
_default_flag_texture = 'a3\data_f\flags\flag_csat_co.paa';							// Texture applied to friendly flags. 			Default: 'a3\data_f\flags\flag_nato_co.paa'
