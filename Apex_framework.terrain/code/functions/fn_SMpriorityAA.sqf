...
private _aaTypes = ['b_apc_tracked_01_aa_f'];
private _aaHulls = [];
private _aaTurrets = [];
...
private _compositionData = [
	...
	[
		["B_T_APC_Tracked_01_AA_F",[-0.0292969,-6.354,0.0168018],178.855,[],TRUE,TRUE,FALSE,{(_this # 0)}],
		["B_T_APC_Tracked_01_AA_F",[-0.321777,8.54443,0.0163908],359.998,[],TRUE,TRUE,FALSE,{(_this # 0)}],
