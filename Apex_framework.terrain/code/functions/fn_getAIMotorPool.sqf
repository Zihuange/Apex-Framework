...
if (_case isEqualTo -1) exitWith {
	// All armed
	[
		'b_mbt_01_tusk_f',(((_tank_modifier * _p_1) * 0.5) min 0.1),
		'b_afv_wheeled_01_up_cannon_f',(((_tank_modifier * _p_1) * 0.5) min 0.1),
...
if (_case isEqualTo 0) exitWith {
	// Classic AO - armed
	_return = [
		'b_mbt_01_tusk_f',((_tank_modifier * _p_0) min 0.1),
		'b_afv_wheeled_01_up_cannon_f',((_tank_modifier * _p_0) min 0.1),
		'b_mbt_01_cannon_f',_tank_modifier * _p_1,
		'i_mbt_03_cannon_f',_tank_modifier * _p_1,
		'b_apc_tracked_01_aa_f',_air_modifier * _p_1,
		'b_afv_wheeled_01_cannon_f',_p_1,
	...
	if (_allPlayersCount > 40) then {
		_return = [
			'b_mbt_01_tusk_f',(((_tank_modifier * _p_2) * 0.75) min 0.1),
			'b_afv_wheeled_01_up_cannon_f',(((_tank_modifier * _p_2) * 0.75) min 0.1),
