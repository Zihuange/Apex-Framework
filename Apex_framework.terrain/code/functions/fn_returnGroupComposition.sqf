...
if (_side isEqualTo EAST) exitWith {
	...
	if (worldName in ['Tanoa','Enoch']) then {
		...
		if (_type isEqualTo 'OIA_InfTeam_AT') then {_return = [['O_T_soldier_TL_F','SERGEANT'],['O_T_soldier_AT_F','CORPORAL'],['O_T_soldier_AAT_F','PRIVATE'],['O_T_soldier_AAT_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'OIA_InfTeam_AT') then {_return = [['O_soldier_TL_F','SERGEANT'],['O_soldier_AT_F','CORPORAL'],['O_soldier_AAT_F','PRIVATE'],['O_soldier_AAT_F','PRIVATE']];breakTo 'main';};
