...
if (_side isEqualTo EAST) exitWith {
	...
	if (worldName in ['Tanoa','Enoch']) then {
		...
		if (_type isEqualTo 'OIA_InfSquad_Weapons') then {_return = [['O_T_Soldier_SL_F','SERGEANT'],['O_T_Soldier_AR_F','PRIVATE'],['O_T_Soldier_GL_F','CORPORAL'],['O_T_Soldier_M_F','SERGEANT'],['O_T_Soldier_AT_F','PRIVATE'],['O_T_Engineer_F','PRIVATE'],['O_T_Soldier_AR_F','PRIVATE'],['O_T_medic_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'OIA_InfTeam_AA') then {_return = [['O_T_soldier_TL_F','SERGEANT'],['O_T_soldier_AA_F','CORPORAL'],['O_T_soldier_AA_F','PRIVATE'],['O_T_Soldier_AR_F','PRIVATE']];breakTo 'main';};
		if (_type isEqualTo 'OIA_InfTeam_AT') then {_return = [['O_T_soldier_TL_F','SERGEANT'],['O_T_soldier_AT_F','CORPORAL'],['O_T_soldier_AT_F','PRIVATE'],['O_T_Soldier_AR_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'OIA_InfTeam_HAT') then {_return = [['O_T_soldier_TL_F','SERGEANT'],['O_T_Soldier_HAT_F','CORPORAL'],['O_T_soldier_AAT_F','PRIVATE'],['O_T_Soldier_A_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'OIA_GuardSquad2') then {_return = [['O_soldierU_GL_F','SERGEANT'],['O_soldierU_GL_F','PRIVATE'],['O_SoldierU_LAT_F','CORPORAL'],[(selectRandomWeighted ['O_SoldierU_M_F',0.75,'O_Urban_Sharpshooter_F',0.25]),'PRIVATE'],['O_SoldierU_AR_F','SERGEANT'],[(selectRandomWeighted ['O_SoldierU_AR_F',0.75,'O_Urban_HeavyGunner_F',0.25]),'CORPORAL'],['O_SoldierU_AR_F','PRIVATE'],['O_Urban_Sharpshooter_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'OIA_InfSentry') then {_return = [['O_soldier_GL_F','CORPORAL'],['O_soldier_GL_F','PRIVATE']];breakTo 'main';};
		if (_type isEqualTo 'OIA_InfSquad') then {_return = [['O_Soldier_SL_F','SERGEANT'],['O_soldier_GL_F','PRIVATE'],['O_Soldier_LAT_F','CORPORAL'],['O_Soldier_M_F','PRIVATE'],['O_Soldier_AR_F','SERGEANT'],['O_Soldier_AR_F','CORPORAL'],['O_engineer_F','PRIVATE'],['O_medic_F','PRIVATE']];breakTo 'main';};
		if (_type isEqualTo 'OIA_InfSquad_Weapons') then {_return = [['O_Soldier_SL_F','SERGEANT'],['O_Soldier_AR_F','PRIVATE'],['O_Soldier_GL_F','CORPORAL'],['O_Soldier_M_F','SERGEANT'],['O_Soldier_AT_F','PRIVATE'],['O_engineer_F','PRIVATE'],['O_G_Soldier_AR_F','PRIVATE'],['O_medic_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'OIA_InfTeam_AA') then {_return = [['O_soldier_TL_F','SERGEANT'],['O_soldier_AA_F','CORPORAL'],['O_soldier_AA_F','PRIVATE'],['O_Soldier_AR_F','PRIVATE']];breakTo 'main';};
		if (_type isEqualTo 'OIA_InfTeam_AT') then {_return = [['O_soldier_TL_F','SERGEANT'],['O_soldier_AT_F','CORPORAL'],['O_soldier_AT_F','PRIVATE'],['O_Soldier_AR_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'OIA_InfTeam_HAT') then {_return = [['O_soldier_TL_F','SERGEANT'],['O_Soldier_HAT_F','CORPORAL'],['O_Soldier_A_F','PRIVATE'],['O_soldier_AAT_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'OG_SniperTeam_M') then {_return = [['O_G_Sharpshooter_F','SERGEANT'],['O_G_Sharpshooter_F','CORPORAL']];breakTo 'main';};
		if (_type isEqualTo 'OG_InfAssaultTeam') then {_return = [['O_G_soldier_TL_F','SERGEANT'],['O_G_soldier_AR_F','CORPORAL'],['O_G_soldier_GL_F','PRIVATE'],['O_G_Soldier_AR_F','PRIVATE']];breakTo 'main';};
	};
...
if (_side isEqualTo WEST) exitWith {
	...
	if (worldName isEqualTo 'Tanoa') then {
		...
		if (_type isEqualTo 'BUS_InfSquad_Weapons') then {_return = [['B_T_Soldier_SL_F','SERGEANT'],['B_T_Soldier_AR_F','PRIVATE'],['B_T_Soldier_GL_F','CORPORAL'],['B_T_Soldier_M_F','SERGEANT'],['B_T_Soldier_AT_F','PRIVATE'],['B_T_Soldier_A_F','PRIVATE'],['B_T_Soldier_AAT_F','PRIVATE'],['B_T_medic_F','PRIVATE']];breakTo 'main';};
		if (_type isEqualTo 'BUS_InfSquad_L') then {_return = [['B_T_soldier_M_F','SERGEANT'],['B_T_soldier_M_F','CORPORAL'],['B_T_soldier_AR_F','PRIVATE'],['B_T_soldier_AR_F','PRIVATE'],['B_T_soldier_AR_F','PRIVATE'],['B_T_soldier_AR_F','PRIVATE'],['B_T_soldier_M_F','PRIVATE'],['B_T_soldier_M_F','PRIVATE'],['B_T_soldier_LAT_F','PRIVATE'],['B_T_soldier_LAT_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'BUS_GuardSentry') then {_return = [['B_T_soldier_GL_F','CORPORAL'],['B_T_soldierU_F','PRIVATE']];breakTo 'main';};
		if (_type isEqualTo 'BUS_ReconTeam') then {_return = [['B_T_Recon_TL_F','SERGEANT'],['B_T_Recon_M_F','CORPORAL'],['B_T_Recon_Medic_F','PRIVATE'],['B_T_Recon_LAT_F','CORPORAL'],['B_T_Recon_JTAC_F','PRIVATE'],['B_T_Recon_Exp_F','PRIVATE']];breakTo 'main';};
		if (_type isEqualTo 'BUS_SniperTeam') then {_return = [['B_T_Sniper_F','SERGEANT'],['B_T_Spotter_F','CORPORAL']];breakTo 'main';};
		if (_type isEqualTo 'BUS_DiverTeam') then {_return = [['B_T_Diver_TL_F','SERGEANT'],['B_T_Diver_Exp_F','CORPORAL'],['B_T_Diver_F','PRIVATE'],['B_T_Diver_F','PRIVATE']];breakTo 'main';};
		if (_type isEqualTo 'BUS_DiverSentry') then {_return = [['B_T_Diver_F','CORPORAL'],['B_T_Diver_F','PRIVATE']];breakTo 'main';};	
		...
		if (_type isEqualTo 'BUS_T_CTRGTeam') then {_return = [['B_CTRG_Soldier_TL_tna_F','SERGEANT'],['B_CTRG_Soldier_JTAC_tna_F','CORPORAL'],['B_CTRG_Soldier_M_tna_F','PRIVATE'],['B_CTRG_Soldier_Exp_tna_F','PRIVATE'],['B_CTRG_Soldier_LAT_tna_F','PRIVATE'],['B_CTRG_Soldier_Medic_tna_F','PRIVATE']];breakTo 'main';};	
		if (_type isEqualTo 'BUS_T_CTRGPatrol') then {_return = [['B_CTRG_Soldier_TL_tna_F','SERGEANT'],['B_CTRG_Soldier_M_tna_F','CORPORAL'],['B_CTRG_Soldier_LAT_tna_F','PRIVATE'],['B_CTRG_Soldier_Medic_tna_F','PRIVATE']];breakTo 'main';};			
		if (_type isEqualTo 'BUS_T_CTRGSentry') then {_return = [['B_CTRG_Soldier_M_tna_F','CORPORAL'],['B_CTRG_Soldier_LAT_tna_F','PRIVATE']];breakTo 'main';};
	} else {
		...
		if (_type isEqualTo 'BUS_InfSquad_L') then {_return = [['B_soldier_M_F','SERGEANT'],['B_soldier_M_F','CORPORAL'],['B_soldier_AR_F','PRIVATE'],['B_soldier_AR_F','PRIVATE'],['B_soldier_AR_F','PRIVATE'],['B_soldier_AR_F','PRIVATE'],['B_soldier_M_F','PRIVATE'],['B_soldier_M_F','PRIVATE'],['B_soldier_LAT_F','PRIVATE'],['B_soldier_LAT_F','PRIVATE']];breakTo 'main';};
		...
		if (_type isEqualTo 'BUS_GuardSentry') then {_return = [['B_soldier_GL_F','CORPORAL'],['B_soldier_F','PRIVATE']];breakTo 'main';};
	...
	if (_type isEqualTo 'IRG_InfAssaultTeam') then {_return = [['B_G_soldier_TL_F','SERGEANT'],['B_G_soldier_AR_F','CORPORAL'],['B_G_soldier_GL_F','PRIVATE'],['B_G_Soldier_A_F','PRIVATE']];breakTo 'main';};
	_return;
};
