...
if (_type isEqualTo 'onLoad') then {
	...
	setMousePosition (uiNamespace getVariable ['QS_ui_mousePosition',getMousePosition]);
	{
		...
		[(_display displayCtrl 1802),'无线电管理'],
		[(_display displayCtrl 1804),'关闭'],
		[(_display displayCtrl 1805),'频道'],
		[(_display displayCtrl 1806),'状态'],
		[(_display displayCtrl 1807),'兼听']
	];
	/*/CHANNEL 6 - GENERAL - 1808, 1816, 1827/*/
	(_display displayCtrl 1808) ctrlSetText '阵营频道';
	(_display displayCtrl 1808) ctrlSetTooltip '某一阵营所有玩家可见';
	(_display displayCtrl 1816) ctrlSetText (if (1 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
	...
	(_display displayCtrl 1809) ctrlSetText '航空频道';
	(_display displayCtrl 1809) ctrlSetTooltip '飞行员与UAV操作员使用';
	(_display displayCtrl 1817) ctrlSetText (if (2 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用 - Encrypted'},{'未启用 - Encrypted'}]);
	...
	(_display displayCtrl 1810) ctrlSetText '主线战区频道';
	(_display displayCtrl 1810) ctrlSetTooltip '主线战区频道';
	(_display displayCtrl 1818) ctrlSetText (if (3 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
	...
	(_display displayCtrl 1811) ctrlSetText '支线任务区域频道';
	(_display displayCtrl 1811) ctrlSetTooltip '支线任务区域频道';
	(_display displayCtrl 1819) ctrlSetText (if (4 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
	...
	(_display displayCtrl 1820) ctrlSetText (if (5 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
	...
	(_display displayCtrl 1821) ctrlSetText (if (6 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
	...
	(_display displayCtrl 1841) ctrlSetText (if (7 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
	...
	(_display displayCtrl 1815) ctrlSetText '通用频道';
	(_display displayCtrl 1815) ctrlSetTooltip 'NSFW';
	(_display displayCtrl 1822) ctrlSetText (if (8 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
	...
	(_display displayCtrl 1824) ctrlSetText (if (9 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
	...
	(_display displayCtrl 1826) ctrlSetText (if (10 in (missionNamespace getVariable 'QS_radioChannels')) then [{'已启用'},{'未启用'}]);
