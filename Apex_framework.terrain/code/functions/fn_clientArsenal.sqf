...
if ((_unit getVariable ['QS_unit_side',WEST]) in [EAST,RESISTANCE]) then {
	_QS_restrictedItems = _QS_restrictedItems -	[
		...
		'u_b_ghilliesuit','u_bg_guerrilla_6_1','u_bg_guerilla1_1','u_bg_guerilla1_2_f','u_bg_guerilla2_2','u_bg_guerilla2_1','u_bg_guerilla2_3','u_bg_guerilla3_1','u_bg_leader',
		'u_b_combatuniform_mcam_worn','u_i_g_story_protagonist_f','u_b_survival_uniform','u_i_c_soldier_para_2_f','u_i_c_soldier_para_3_f','u_i_c_soldier_para_5_f','u_i_c_soldier_para_4_f',
		'u_i_c_soldier_para_1_f','u_b_pilotcoveralls','u_b_helipilotcoveralls','u_b_combatuniform_mcam_vest','u_i_c_soldier_camo_f'
	];
};
