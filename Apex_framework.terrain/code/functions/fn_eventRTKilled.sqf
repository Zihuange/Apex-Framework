...
_radioTowerDownText = parseText "<t align='center' size='2.2'>无线电塔</t><br/><t size='1.5' color='#08b000' align='center'>已被摧毁</t><br/>____________________<br/>敌方无线电塔已经被摧毁，干得好伙计们！<br/><br/><t size='1.2' color='#08b000' align='center'> 敌军已经无法继续呼叫空中支援了！</t><br/>";
...
if (!isNull _killer) then {
	if (isPlayer _killer) then {
		...
		if ((random 1) > 0.5) then {
			['sideChat',[EAST,'HQ'],(format ['%1 %2',_name,localize 'STR_QS_Chat_008'])] remoteExec ['QS_fnc_remoteExecCmd',-2,FALSE];
		} else {
			['sideChat',[EAST,'HQ'],(format ['%1 %2',_name,localize 'STR_QS_Chat_009'])] remoteExec ['QS_fnc_remoteExecCmd',-2,FALSE];
		};
