...
private _unitTypes = ['SPE_FFI_TeamLeader'];
...
uiSleep 0.1;
[_objUnit,(selectRandom ['SPE_M1911', 'SPE_P08']),5] call (missionNamespace getVariable 'QS_fnc_addWeapon');
_objUnit setUnitPos 'UP';
_objUnit enableAIFeature ['PATH',FALSE];
_objUnit forceAddUniform 'U_SPE_FFI_Casual_1';
_objUnit addVest 'V_SPE_FFI_Vest_SMG';
_objUnit addBackpack 'B_SPE_CIV_musette';
