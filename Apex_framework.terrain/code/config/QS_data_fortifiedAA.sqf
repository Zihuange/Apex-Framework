...
if (worldName isEqualTo 'Cam_Lao_Nam') exitWith {
	if ((random 1) > 0.333) then [
		{
			[
				[(selectRandomWeighted ['vn_o_nva_65_static_zpu4',0.75,'vn_o_nva_static_zpu4',0.25]),[-5.34766,0.143311,0.016685],270.378,[],FALSE,FALSE,FALSE,(missionNamespace getVariable 'QS_fnc_createAAVehicle')], 
		...
		{
			[
				[(selectRandomWeighted ['vn_o_nva_65_static_zpu4',0.75,'vn_o_nva_static_zpu4',0.25]),[2.54688,-0.0488281,-0.0447016],270.525,[],FALSE,FALSE,FALSE,(missionNamespace getVariable 'QS_fnc_createAAVehicle')], 
