...
if (worldName in ['Tanoa','Lingor3','Enoch']) exitWith {
	if ((random 1) > 0.333) then [
		{
			[
				["b_t_apc_tracked_01_aa_f",[-5.34766,0.143311,0.016685],270.378,[],FALSE,FALSE,FALSE,(missionNamespace getVariable 'QS_fnc_createAAVehicle')], 
		...
		{
			[
				["b_t_apc_tracked_01_aa_f",[2.54688,-0.0488281,-0.0447016],270.525,[],FALSE,FALSE,FALSE,(missionNamespace getVariable 'QS_fnc_createAAVehicle')], 
...
if ((random 1) > 0.333) then [
	{
		[
			["b_apc_tracked_01_aa_f",[-5.34766,0.00170898,0.0160155],269.875,[],FALSE,FALSE,FALSE,(missionNamespace getVariable 'QS_fnc_createAAVehicle')], 
	...
	{
		[
			["b_apc_tracked_01_aa_f",[-5.34375,0.18335,0.0162873],271.02,[],FALSE,FALSE,FALSE,(missionNamespace getVariable 'QS_fnc_createAAVehicle')], 
