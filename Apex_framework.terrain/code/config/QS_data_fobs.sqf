...
if (_worldName isEqualTo 'Altis') exitWith {
	...
	if (_type isEqualTo 0) then {
		...
		_return = [
			...
			[
				["B_MBT_01_TUSK_F",[11805.6,22293.5,-0.0551891],91.3296],
				["B_APC_Wheeled_01_cannon_F",[11805.2,22301.7,-0.0624695],92.2692],
				["B_MRAP_01_F",[11829.8,22271,0.00987434],1.36946],
				["B_MRAP_01_hmg_F",[11837.8,22271,-0.00250244],1.42604],
				["B_MRAP_01_gmg_F",[11846.1,22270.5,-0.00465584],1.39603],
	...
	if (_type isEqualTo 1) then {
		...
		_return = [
			...
			[
				...
				["B_MRAP_01_gmg_F",[5373.58,17927.1,0.00133514],177.623],
				["B_MRAP_01_hmg_F",[5382.14,17928.2,0.0809021],177.544],
				["B_MBT_01_TUSK_F",[5429.07,17893.5,-0.0491638],280.279],
				["B_APC_Wheeled_01_cannon_F",[5430.26,17901.2,-0.0496674],278.539]
			],
	...
	if (_type isEqualTo 2) then {
		...
		_return = [
			...
			[
				...
				["B_MRAP_01_hmg_F",[22031.3,19913.2,0.0051918],65.6393],
				["B_MRAP_01_gmg_F",[22034.3,19905.5,0.0108347],65.6277],
				["B_Quadbike_01_F",[22062.2,19898.5,-0.00395203],354.247],
				["B_Quadbike_01_F",[22064.8,19898.7,-0.00516605],354.131],
				["B_Truck_01_medical_F",[22057.6,19924.3,0.0553885],341.621],
				["B_MBT_01_TUSK_F",[22114.9,19899.1,-0.0410919],355.691],
				["B_APC_Wheeled_01_cannon_F",[22123.4,19900.2,-0.0485096],352.209]
			],
	...
	if (_type isEqualTo 3) then {
		...
		_return = [
			...
			[
				...
				["B_MRAP_01_hmg_F",[16889.8,10002.5,0.00481033],155.721],
				["B_MRAP_01_gmg_F",[16874.3,9996.34,-0.00241661],155.69],
				["B_MRAP_01_F",[16882,9999.41,0.00616455],155.69],
				["B_Truck_01_transport_F",[16936.4,9942.61,0.0241432],360],
				["B_MBT_01_TUSK_F",[16946.8,9968.09,0.00372124],309.319],
				["B_APC_Wheeled_01_cannon_F",[16951.9,9974.55,0.0277157],312.59]
			],
	...
	if (_type isEqualTo 4) then {
		...
		_return = [
			...
			[
				...
				["B_MBT_01_TUSK_F",[7399.16,11458.2,-0.0286922],236.93],
				["B_APC_Wheeled_01_cannon_F",[7402.32,11453.2,-0.0541878],230.705],
				["B_Truck_01_medical_F",[7389.56,11440.7,0.0324707],272.339],
				["B_MRAP_01_F",[7389.78,11470.6,0.0311069],235.601],
				["B_MRAP_01_hmg_F",[7393.9,11464.1,-0.00195313],235.777],
				["B_MRAP_01_gmg_F",[7385.48,11477.4,0.0118809],235.75]
			],
	...
	if (_type isEqualTo 0) then {
		...
		_return = [
			...
			[	
				...
				["B_T_APC_Wheeled_01_cannon_F",[11100,11527.3,-0.0106201],183.908],
				["B_T_APC_Wheeled_01_cannon_F",[11115.6,11526.1,-0.0115051],184.125]
			],
	...
	if (_type isEqualTo 1) then {
		...
		_return = [
			...
			[
				...
				["B_T_APC_Wheeled_01_cannon_F",[11669.7,4413.76,0.0231323],185.49],
				["B_T_Truck_01_transport_F",[11696.3,4355.61,0.0588837],274.828],
				["B_T_APC_Wheeled_01_cannon_F",[11677.9,4413.07,0.0438843],186.4]
			],
	...
	if (_type isEqualTo 2) then {
		_return = [
			...
			[
				...
				["B_T_APC_Wheeled_01_cannon_F",[4899.22,5076.92,-0.00946331],33.1819],
				["B_T_LSV_01_AT_F",[4906.42,5072.76,0.00765419],33.1828],
				["B_T_APC_Wheeled_01_cannon_F",[4892.45,5080.95,-0.0166426],33.1285],
	...
	if (_type isEqualTo 3) then {
		_return = [
			...
			[
				...
				["B_T_APC_Wheeled_01_cannon_F",[3966.73,11791.9,-0.00606155],49.8424],
				...
				["B_T_APC_Wheeled_01_cannon_F",[3994.96,11845.9,-0.0279751],208.667]
			],
...
if (_worldName isEqualTo 'Malden') exitWith {
	...
	if (_type isEqualTo 0) then {
		...
		_return = [
			...
			[
				["B_MBT_01_TUSK_F",[5944.97,9662.78,-0.000183105],54.1998],
				["B_APC_Wheeled_01_cannon_F",[5939.81,9669.36,-0.00164795],56.8689],
	...
	if (_type isEqualTo 1) then {
		...
		_return = [
			...
			[
				...
				["B_APC_Wheeled_01_cannon_F",[3811.95,4735.12,0.0132904],63.9927],
				["B_MBT_01_TUSK_F",[3807.32,4741.49,-0.0360184],64.3722],
...
if (_worldName isEqualTo 'Enoch') exitWith {
	...
	if (_type isEqualTo 0) then {
		...
		_return = [
			...
			[
				...
				["B_T_APC_Wheeled_01_cannon_F",[5534.72,9407.45,0.149034],190.447],
				["B_T_MRAP_01_hmg_F",[5541.83,9405.38,0.149063],190.447],
				["B_T_MRAP_01_gmg_F",[5550.25,9403.53,0.149152],190.447],
				["B_T_Quadbike_01_F",[5539.24,9360.42,0.200735],282.621],
				["B_T_Quadbike_01_F",[5540.25,9363.8,0.200786],285.042],
				["B_T_AFV_Wheeled_01_up_cannon_F",[5579.66,9369.34,0.0581274],278.564],
				["B_T_MBT_01_TUSK_F",[5578.64,9361.71,0.0766859],277.015]
			],
	...
	if (_type isEqualTo 1) then {
		...
		_return = [
			...
			[
				["B_T_APC_Wheeled_01_cannon_F",[3028.19,5040.57,0.193939],328.081],
				["B_T_MRAP_01_hmg_F",[3021.4,5035.97,0.197433],326.021],
				["B_T_MRAP_01_gmg_F",[3014.82,5031.16,0.201523],325.998],
				...
				["B_T_AFV_Wheeled_01_up_cannon_F",[2952.52,5079.88,0.0759277],140.99],
				["B_T_MBT_01_TUSK_F",[2958.58,5085.15,0.0866699],140.42]
			],
	...
	if (_type isEqualTo 2) then {
		...
		_return = [
			...
			[
				...
				["B_T_MBT_01_TUSK_F",[11633.8,7963.49,0.0734138],357.128],
				["B_T_AFV_Wheeled_01_up_cannon_F",[11625.6,7963.96,0.0639992],359.096],
				["B_T_APC_Wheeled_01_cannon_F",[11605.5,7992.4,0.18536],103.937],
				["B_T_MRAP_01_hmg_F",[11607.4,8000.44,0.176075],101.834],
				["B_T_MRAP_01_gmg_F",[11609.1,8008.27,0.174536],104.966]
			],
