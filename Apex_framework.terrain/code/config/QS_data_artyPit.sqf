...
[
	...
	[(["B_MBT_01_arty_F","B_T_MBT_01_arty_F"] select (worldName in ['Tanoa','Lingor3','Enoch'])),[4.01807,-1.67236,-0.0691381],353.719,[],true,true,false,{
		...
		(gunner _arty) addEventHandler [
			'FiredMan',
			{
				...
				['sideChat',[EAST,'HQ'],(selectRandom _firingMessages)] remoteExec ['QS_fnc_remoteExecCmd',-2,FALSE];
			}
		];
		{
	...
	[(["B_MBT_01_arty_F","B_T_MBT_01_arty_F"] select (worldName in ['Tanoa','Lingor3','Enoch'])),[-6.7666,-2.89453,-0.0691385],353.719,[],true,true,false,{
		_arty = _this select 0;
		(missionNamespace getVariable 'QS_sideMission_enemyArray') pushBack _arty;
		_arty setVariable ['QS_hidden',TRUE,TRUE];
		_arty addEventHandler [
